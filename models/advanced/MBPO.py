...
class MBPOAgent:
    ...
    def __init__(self, 
                ...
                num_dynamics_networks: int,
                rollout_length: int,
                num_rollouts: int,
                number_hidden_units_dynamics: int,
                seed: int = None):
        random.seed(seed)
        self._random_state = np.random.RandomState(seed)
        self._env = env
        self._number_hidden_units_agent = number_hidden_units_agent
        self._gamma = gamma
        ...
        self._num_dynamics_networks = num_dynamics_networks
        self._number_hidden_units_dynamics = number_hidden_units_dynamics
        ...
        self._critic_local = Network(input_dimension=self._state_size,
                                    ...
                                    number_hidden_units=self._number_hidden_units_agent).to(self._device)
        ...
        self._actor_local = Network(
            ...
            output_dimension=self._action_size,
            number_hidden_units=self._number_hidden_units_agent,
