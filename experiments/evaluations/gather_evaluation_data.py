...
def gather_evaluation_data():
    ...
    SEEDS = [105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120]
                ...
                for agent_type in AGENT_TYPES:
                    ...
                    for mbrl_key in MBRL_KEYS:
                        ...
                        results = single_training_run(
                            ...
                            print_flag = False,
                            seed = seed)
                        file_path = f"experiments/evaluations/results/{agent_type}_{mbrl_key}_{ground_type}_{drywet}_{seed}.pickle"
    ...
    #                 plot_flag = False,
    #                 seed = 43)
    #             file_path = f"experiments/evaluations/results/symbolic_only_filter_{ground_type}_{drywet}_{seed}.pickle"
    #             with open(file_path, 'wb') as handle:
    #                 pickle.dump(results, handle, protocol=pickle.HIGHEST_PROTOCOL)
    ...
    #                 plot_flag = False,
    #                 seed = 43)
    #             file_path = f"experiments/evaluations/results/only_random_{ground_type}_{drywet}_{seed}.pickle"
    #             with open(file_path, 'wb') as handle:
    #                 pickle.dump(results, handle, protocol=pickle.HIGHEST_PROTOCOL)
